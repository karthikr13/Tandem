...
def read_data_sine_test_1d(flags, eval_data_all=False):
    ...
    return get_data_into_loaders(data_x, data_y, flags.batch_size, SimulatedDataSet_class_1d_to_1d,
                                 test_ratio=flags.test_ratio)


def read_data_sine_wave(eval_data_all=False):
    """
    ...
    if eval_data_all:
        return get_data_into_loaders(data_x, data_y, 1024, SimulatedDataSet_class, test_ratio=0.999)
    return get_data_into_loaders(data_x, data_y, 1024, SimulatedDataSet_class, test_ratio=0.2)
